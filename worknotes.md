...
We've looped all the way around, gotten basic system scripting working in Frontier, and now I want to work on one of the nodeEditor projects, the one that will be about relating to people about what Frontier is in the 2020s.

Today I want to get the repo updating, and tomorrow I figure out how to put up a demo script. We're going to flood the zone with examples that work.

#### 8/20/26; 10:25:57 AM by DW

Today I want to come up with a process to update example scripts.

#### 8/19/26; 11:24:52 AM by DW
